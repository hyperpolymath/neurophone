...
git clone <https://github.com/hyperpolymath/neurophone.git> cd
neurophone
...
toolbox create neurophone-dev toolbox enter neurophone-dev \# Install
...
neurophone/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \# Library
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/neurophone/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/neurophone/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/neurophone/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/neurophone/labels/perimeter-3) — Community sandbox scope
