{
  description = "neurophone - {project-description}";
      ...
      in
      {
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P neurophone.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/neurophone $out/bin/  # Rust
            # cp bin/neurophone $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/neurophone";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-neurophone" {
