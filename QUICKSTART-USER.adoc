...
// Replace neurophone, Neurophone — See README.adoc for details., just run, Neurophone started successfully. with actuals
= neurophone — Quick Start for Users
:toc:
:toclevels: 2

== What is neurophone?

Neurophone — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./neurophone-portable
----
...
[source]
----
Neurophone started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/neurophone/wiki
